...
def init_pymol():
    print("\nInitialising pymol...\n")
    #launch pymol and wait for it
    pymol.finish_launching(['pymol', '-nqc'])
    pymol.cmd.reinitialize()

    # set PyMOL parameters for visuals
...
def align_to_template(pdb, file_name, mhc_class):
    ...
    #get the path of the data in our pkg
    local_template = "data/" + mhc_class + "_template.pdb"
...
def calculate_and_print(pdb, fasta, mhc_class, ray, chains, file_name):
    ...
    centroids_file = read_pkg_file("data/centroids_target.pdb")
    pymol.cmd.load(centroids_file, "centroids_target")
...
#    pymol.cmd.show("surface", "MHCb")
    ...
    pymol.cmd.align("mobile", "centroids_target")
