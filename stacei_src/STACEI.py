...
# Our own imports
import stacei.bin.new_automated_annotation as annotation
import stacei.bin.housekeeping as housekeeping
import stacei.bin.containers as classes
import stacei.bin.VDJ_usage as vdj
import stacei.bin.insertion_aware_VDJ_usage as vdj_out
import stacei.bin.renumber_pdb_clean as imgt
import stacei.bin.contacts as contacts
import stacei.bin.contact_map as con_map
import stacei.bin.peptide_pisa as peptide_pisa
import stacei.bin.full_pisa as full_pisa
import stacei.bin.planar_crossing_angle as crossing_angle
import stacei.bin.pymol_cdr_loops as pymol_cdr
import stacei.bin.peptide_MHC_visualise as electrostatic
import stacei.bin.shape_complementarity as sc
import stacei.bin.html_operations as html_ops
...
def main():
 ...
 ####################################################################################################################
    ...
    bsa_script = housekeeping.read_pkg_file("R/peptide_BSA.R")
    subprocess.call("Rscript %s %s" %(bsa_script, pisa_files.pept_chains), shell=True)

    print("Making Circos plots")
    circos_script = housekeeping.read_pkg_file("R/circos_and_pie.R")
